...
Thus, one may write
\begin{align}
\fplus{\rho}(k, q) = \rho_{\inf}(k, q) + \rho_\mathrm{reg}(k, q)\ ,
\qquad  \rho_\mathrm{reg}(k, q) =
- \fplus{K}_\rho(k, q)
...
\fplus{rho}(k, q) = \dct{\rho}(k, q)
 ...
 + \delta \rho_\infty(k, q) + \rho_\mathrm{reg}(k, q)\ ,
\end{align}
with the excess density~$\delta\rho_\infty(k, q)$ given by
\begin{align}
...
\begin{equation}
  ...
  - \fplus{K}_\Omega(k, q) \left[\fminus{S}_\Omega(k, q)
