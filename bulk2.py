class InjectedFlow(Flow):
    def __init__ (self, h, k, K_up, path_up, K_dn, path_dn):
        ...
        self.chi_p_up = self.path_up.eval(self.chi_plus)
        self.chi_m_dn = self.path_dn.eval(self.chi_minus)
    ...
    def rho_sing_y(self, y):
        ...
        return 1.0/np.pi * special.kn(0, kappa * np.abs(y - self.h))
